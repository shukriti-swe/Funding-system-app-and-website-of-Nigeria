                                            ...
                                            <div class="box-body">
                                                <table class="table  table-hover table-responsive" style="    width: 100%;">
                                                    ...
                                                    <thead>
                                                       ...
                                                       <th><?php echo currency($potential_winnings+$thrift['thrift_group_product_price']); ?></th>
                                                       <?php } else{?>
                                                    ...
                                                    <thead>
                                                        <th>Thrift Winner:</th>
                                                        <?php if (!empty($Thrift_winner)){?>
                                                       <th>
                                                           <?php  echo  $Thrift_winner[0]['user_name'];
                                                       ?></th>
                                                       <?php }else{ ?>
                                                        <th><?php  echo "Thrift Not End";?></th>
                                                      <?php } ?>
                                                    </thead>
                                                    <!-- <thead>
                                                        <th>Thrift Name:</th>
                                                        <?//php if (!empty($Thrift_winner)){?>
                                                       <th>
                                                           <?//php// echo  $Thrift_winner[0]['thrift_name'];
                                                       ?></th>
                                                       <?//php } ?>
                                                    </thead> -->
