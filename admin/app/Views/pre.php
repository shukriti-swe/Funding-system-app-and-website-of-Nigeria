...
<head>
	<meta charset="UTF-8">
	<title>Welcome to Thrift 2 Win</title>
...
<header>
	...
	<div class="heroe">
		...
		<h1>Welcome to Thrift 2 Win</h1>

		<h2>A Prosperis Gold Product - CI Version <?= CodeIgniter\CodeIgniter::CI_VERSION ?></h2>
...
<section>
	...
	<p>ProsperisGold is a modern version of traditional thrifting with the added advantage of financial technology. We present to you a fully automated platform where a group of individuals or corporate entities can save money together over a period of time, and take turns in receiving the accumulated sums on a rotational basis. ProsperisGold blends accountability, discipline, and transparency in our services to help you develop healthy saving habits.</p>

        <h1>For Project Setup</h1>
        
	<p>1. Clone the project from develop branch</p>

	<pre><code>Composer install</code></pre>
        
        <p>2. Give permission to writable folder</p>

	<pre><code>sudo chmod -R 777 writable/</code></pre>
...
<footer>
	...
	<div class="copyrights">
            <p>&copy; <?= date('Y') ?> Thrift 2 Win. Developed in CodeIgniter</p>
	</div>
</footer>
