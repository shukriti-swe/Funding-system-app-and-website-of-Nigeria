                                        ...
                                        <div class="box box-primary">
                                            <div class="box-header">
                                                ...
                                                <a class="btn btn-primary "
                                                   href="message_module/send_message/">text
                                                    &nbsp;<span class="icon"><i class="fa fa-plus"></i></span>
                                                </a>

                                                
                                                    <div class="m-t-10 alert alert-success alert-dismissible fade show"
                                                         role="alert">
                                                            ...
                                                            <div class="box box-primary">
                                                                            ...
                                                                            <tr id="filter_col3" data-column="3">
                                                                                ...
                                                                                <td align="center">
                                                                                    <input class="column_filter form-control"
                                                                                           id="col3_filter"
                                                                                           type="hidden">
                                                                                    <select id="custom_archive_status_filter"
                                                                                            class="form-control">
                                                                            ...
                                                                            <tr id="filter_col4" data-column="4">
                                                                                ...
                                                                                <td align="center">
                                                                                    <input class="column_filter form-control"
                                                                                           id="col4_filter"
                                                                                           type="hidden">
                                                                                    <select id="custom_read_status_filter"
                                                                                            class="form-control">
                                                                                        <option value="all">text</option>
                                                                                        <option value="yes">text</option>
                                                                                        <option value="no">text</option>
                                                                ...
                                                                <div class="box-body">
                                                                    <table id="inbox-table"
                                                                           class=" datatable dataTable  table table-bordered table-hover table-responsive ">
                                                                        <thead>
                                                                        <tr>
                                                                            <th>text</th>
                                                                            <th>text</th>
    ...
    $(document).ready(function () {
        ...
        $('#inbox-table').DataTable({
            ...
            columnDefs: [
                ...
                {orderable: false, targets: [5]} /*, { visible: false, targets: [3,5,6] }*/
            ],

            aaSorting: [[0, 'desc']],

            ajax: {
                url: "<?php echo base_url() . 'message_module/get_inbox_message_list_by_ajax' ?>",                   // json datasource
                type: "post",
...
<script>
    ...
    $(function () {
        ...
        /*-----------------------------*/
        $('#custom_archive_status_filter').on('change', function () {

            if ($('#custom_archive_status_filter').val() == 'all') {
                $('#col3_filter').val('');
                filterColumn(3);
            } else {
                $('#col3_filter').val($('#custom_archive_status_filter').val());
                filterColumn(3);
            }
        ...
        /*-----------------------------*/
        $('#custom_read_status_filter').on('change', function () {

            if ($('#custom_read_status_filter').val() == 'all') {
                $('#col4_filter').val('');
                filterColumn(4);
            } else {
                $('#col4_filter').val($('#custom_read_status_filter').val());
                filterColumn(4);
            }
...
<script>
    ...
    $(function () {
        ...
        document.querySelector('p').innerText = truncateText('p', 15);
