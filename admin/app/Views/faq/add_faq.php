...
<div class="container">
        ...
        <div class="col-xl-12">
            <div class="page-title-box">
                ...
                <ol class="breadcrumb float-right">
                    ...
                    <li class="breadcrumb-item active"><?= lang('faq.add_faqs'); ?></li>
                </ol>
    ...
    <div class="row">
        <div class="col-12">
            <div class="card-box">
                <h4 class="header-title m-t-0 m-b-30"><?= lang('faq.add_faqs'); ?></h4>
                <div class="row">
                    <div class="col-lg-12 col-sm-12 col-xs-12 col-md-12 col-xl-6">
                        ...
                        <form action="<?php echo base_url('addfaq');?>" role="form" method="post" enctype="multipart/form-data">

                            <div class="box-body">
                                <div class="form-group">
                                    <label for="question"><?= lang('faq.question'); ?> ?</label>
                                    <input type="text" name="question" class="form-control" id="question" placeholder="<?= lang('faq.question'); ?>" autocomplete="Off">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="answer" class="form-control" id="answer" placeholder="<?= lang('faq.answer'); ?>" autocomplete="Off"></textarea>
                            ...
                            <div class="box-footer">
                                <button type="submit" id="btnsubmit" class="btn btn-primary"><?= lang('faq.add_faqs'); ?></button>
                            </div>
