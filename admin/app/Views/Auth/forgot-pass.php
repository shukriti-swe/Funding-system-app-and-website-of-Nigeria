                ...
                <div class="col-md-5 text-center mt-4 pt-4 pb-4">
                    ...
                    <form action="<?php echo base_url(); ?>/auth/forgot_password" method="post"> 
                        ...
                        <div class="input-group mb-3 align-items-center">
                            ...
                            <input id="email" class="form-control " type="email" name="email" placeholder="Email" value=""  aria-describedby="basic-addon1" required autocomplete="Off">

                            <small style="color:red;" class="text-danger"><?php
                                if (isset($validation)) {
