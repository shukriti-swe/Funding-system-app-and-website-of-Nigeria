                                                    ...
                                                    <div class="box box-primary">
                                                        ...
                                                        <div class="box-body">
                                                            <table id="inbox-table" class="table table-bordered table-hover table-responsive ">
                                                                ...
                                                                <tbody>
                                                                    <?php foreach ($getAllSupMsg as $supportmgs) : ?>
                                                                        <td><?= date('d M, h:i A', strtotime($supportmgs['created_at'])) ?></td>
                                                                        <td><?= $supportmgs['message']; ?></td>
                                                                        <td>
                                                                            <a title="View Message" href="<?= base_url()
                                                                            ?>/inbox_view_message/<?= $supportmgs['id'] ?>/<?= $supportmgs['ticket_id'] ?>" style="color:#2b2b2b">
                                                                                <i class="fa fa-eye fa-lg" aria-hidden="true"></i>
                                                                            </a>
                                                                            <a title="Delete Message" href="<?= base_url() ?>/delete_message/<?= $supportmgs['id'] ?>" style="color:#2b2b2b">
