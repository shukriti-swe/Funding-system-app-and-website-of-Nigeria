...
#In phpunit.xml, update baseUrl

<php>
    <server name="app.baseURL" value="XXXXXXXX"/>
</php>

#In phpunit.xml, update testsuite's

<testsuites>
        <testsuite name="App"> # name unique
                <directory suffix=".php">./tests/app</directory>
        </testsuite>
</testsuites>

#Create Test Controller's in tests/app folder & Assert Testing conditions

#Run Unit Test Case by running following cmd

vendor/bin/phpunit

#Few cmd's to note

vendor/bin/phpunit --list-suite // to list test suite
vendor/bin/phpunit --list-tests // to list test cases
vendor/bin/phpunit --testsuite App // to execute specific suite

# Unit Test needs to have seperate DB, so create seperate db, like test_XXXXXXXX
# Uncomment & update values in .env file for UnitTest db
# Clear cache after update env file

#===============================================================================
#=========================CUSTOM READ ME ENDS HERE==============================
#===============================================================================
