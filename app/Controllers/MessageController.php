...
class MessageController extends BaseController {
    ...
    public function messageList() {
        ...
        $output = $this->array_multidimensional_unique($results);
    
        $sucess = $this->generateSuccess(lang('Message.message_list'), $output);
    ...
    public function messageSend() {
        ...
        $messageData['ticket_id'] = (!$this->request->getPost('ticket_id') || $this->request->getPost('ticket_id') == 'null' || $this->request->getPost('ticket_id') == null) 
        ? time() : $this->request->getPost('ticket_id');
        ...
        if ($isSuccess) {
            ...
            $messageData['id'] = $supportMessageModel->insertId();
