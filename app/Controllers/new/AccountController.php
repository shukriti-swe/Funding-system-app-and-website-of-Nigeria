...
class AccountController extends BaseController
{
    ...
    public function getAmount()
    {
        ...
        $sucess = $this->generateSuccess(lang('Account.user_current_balance',[ $info['balance']]), $info);
        return $this
            ->getResponse(
                $sucess
            );
    ...
    */
    ...
    public function dashboard() {
        ...
        $content_thrifts['current_thrift'] = $info['active_thrift']; // demo contents to be replaced when winners api s are completed
        $content_thrifts['available_balance'] = $info['balance']; 
        $content_thrifts['referal_earnings'] = $info['referral_amount'];
    ...
    private function getUserWallet(){
        ...
        return [ 
            'balance'=>$balance,
            'referral_amount'=>$total_referral,
            'active_thrift'=>$active_amount
        ];
    }
